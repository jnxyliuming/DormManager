...
<div class="col-lg-6 col-lg-offset-2">
    <form role="form" action="http://localhost:8080/DormManage/DormManagerServlet?action=save" method="post" onsubmit="return checkForm1()">
        <c:if test="${user.id==null}">
            <p class="text-success" style="text-align: center;font-size: medium">添加管理员</p>
        </c:if>
        <c:if test="${user.id!=null}">
            <p class="text-success" style="text-align: center;font-size: medium">修改人员</p>
        </c:if>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9" style="margin-top: 3%">
                    <input type="text" class="form-control" id="phone" name="tel" value="${user.tel}">
                        ...
                        <div class="form-group">
                            <label for="build" class="col-sm-3 control-label" style="margin-top: 3%">管理栋楼</label>
                            <div class="col-sm-9" style="margin-top: 3%" id="build">
                        <c:forEach items="${builds}" var="build" >
                            <label class="checkbox-inline">
                                <input type="checkbox" name="dormBuildId" value="${build.id}">${build.name}
                            </label>
                        </c:forEach>
                            </div>
                        </div>
    ...
    <div class="col-lg-6 col-lg-offset-5" style="margin-top: 7%">
        ...
        <a href="http://localhost:8080/DormManage/DormManagerServlet?action=list" class="btn btn-info"  style="margin-top: 7%">返回</a>
    </div>
    </form>
</div>
</body>
